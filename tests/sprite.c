...
{
  STRPTR utext = "Arrow keys to move sprite  F1 to F4 - Zoom factor  F5-F6 Rotate sprite  ESC - Quit";
  STRPTR btext = "H - Horizontal flip  V - Vertical flip  F - Filtering on/off  Space - Reset sprite";
